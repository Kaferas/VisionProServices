...
@section('title')
    Listes des Categories d'article
@endsection
...
@section('content')
    ...
    <div class="row mt-3">
        ...
        <div class="col-12 d-flex flex-wrap align-items-center mb-3">
            <a data-href="{{ route('category.store') }}" onclick="toggleModal(this)" class="btn btn-primary me-2 mb-2">Nouveau</a>
            ...
            <div class="dropdown me-2 mb-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li>
                        <a class="dropdown-item" href="#"><i class="fa fa-print me-2"></i>Print</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="#"><i class="fa fa-file-excel me-2"></i>Export to Excel</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="#"><i class="fa fa-file-pdf me-2"></i>Export to PDF</a>
                    </li>
                </ul>
            </div>
            ...
            <a href="{{ route('category.index') }}" class="btn btn-light ms-2 mb-2"><i class="fa fa-refresh"></i></a>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-around">
                                            <a data-href="{{ route('category.update',['category' => $value]) }}"
                                                data-category="{{ json_encode($value) }}" onclick="toggleEditModal(this)"
                                                class="btn btn-outline-warning"><i class="fa fa-edit"></i></a>
                                            <a data-href="{{ route('category.destroy',['category' => $value]) }}"
    ...
    <div class="modal fade" id="formModuleModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <x-modal-header>Ajout d'une catégorie</x-modal-header>
                <form id="add_data_form">
                    <x-modal-body>
                        @csrf
                        <div class="mb-3">
                            <x-input :type="'text'" :label="'Nom de la categorie'" :name="'title'" :value="''" :required="true" />
                        </div>
                    </x-modal-body>
